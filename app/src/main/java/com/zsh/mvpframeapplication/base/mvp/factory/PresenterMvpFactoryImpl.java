 ...
 */
public class PresenterMvpFactoryImpl <V extends IBaseView, P extends BaseMvpPresenter<V>> implements PresenterMvpFactory<V, P> {
     ...
     * @return 工厂类
     */
    public static <V extends IBaseView, P extends BaseMvpPresenter<V>> PresenterMvpFactoryImpl<V, P> createFactory(Class<?> viewClazz) {
