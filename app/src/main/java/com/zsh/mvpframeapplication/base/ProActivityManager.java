...
public class ProActivityManager {
     ...
     * @param ：[activity]
     * @return : void
     * @methodName ：destroyActivity created by luozhipeng on 22/11/17 17:31.
     * @description ：销毁指定的Activity
     */
    public synchronized void destroyActivity(Activity activity, boolean isDestoryed) {
        if (activity != null) {
            if (activities.contains(activity)) {
